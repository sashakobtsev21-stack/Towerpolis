...
namespace Towerpolis.Game.UI
{
    ...
    public static partial class LocTables
    {
        public static readonly Dictionary<string, string> Ru = new()
        {
            ...
            { LocKeys.HudComboCoins, "+{0} монет" },
            { LocKeys.HudTrophyLine, "\nТРОФЕЙ ЗА СЕРИЮ  +{0} жильцов" },

            // ----- Meta HUD chrome -----
            { LocKeys.MetaMenu,           "МЕНЮ" },
            ...
            { LocKeys.MetaSettings,       "НАСТРОЙКИ" },
            { LocKeys.MetaLanguage,       "ЯЗЫК" },
            { LocKeys.MetaSoundOn,        "ЗВУК ВКЛ" },
            { LocKeys.MetaSoundOff,       "ЗВУК ВЫКЛ" },
            { LocKeys.MetaReset,          "ЗАНОВО" },
            { LocKeys.MetaResetConfirm,   "ТОЧНО?" },
            ...
            // ----- Prestige -----
            { LocKeys.PrestigeTitle,     "ГОРОД ПОСТРОЕН!" },
            { LocKeys.PrestigePopLine,   "Население  {0}" },
            { LocKeys.PrestigeStarsLine, "+{0} звёзд престижа" },
            { LocKeys.PrestigeBonusLine, "Бонус жильцов  ×{0}" },
            { LocKeys.PrestigeKeptLine,  "Монеты сохранены  {0}" },
            { LocKeys.PrestigeButton,    "ПРЕСТИЖ" },
