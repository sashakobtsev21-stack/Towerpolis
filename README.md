...
| **Core** | `Towerpolis.Core` — Unity-free C#, **279 NUnit tests green** (`dotnet test`) |
...
- [`docs/PROJECT_STATUS.md`](docs/PROJECT_STATUS.md) — **living status: what's done, what's left, history & plan** (start here)
